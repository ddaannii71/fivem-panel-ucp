...
-- Volcando datos para la tabla fivem_panel.addon_account: ~8 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.addon_account_data: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.addon_inventory: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.addon_inventory_items: ~0 rows (aproximadamente)
DELETE FROM `addon_inventory_items`;

-- Volcando datos para la tabla fivem_panel.banking: ~0 rows (aproximadamente)
DELETE FROM `banking`;

-- Volcando datos para la tabla fivem_panel.billing: ~0 rows (aproximadamente)
DELETE FROM `billing`;

-- Volcando datos para la tabla fivem_panel.cardealer_vehicles: ~0 rows (aproximadamente)
DELETE FROM `cardealer_vehicles`;

-- Volcando datos para la tabla fivem_panel.datastore: ~9 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.datastore_data: ~5 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.fine_types: ~52 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.items: ~33 rows (aproximadamente)
DELETE FROM `items`;
...
-- Volcando datos para la tabla fivem_panel.job_grades: ~36 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.jobs: ~14 rows (aproximadamente)
DELETE FROM `jobs`;
...
-- Volcando datos para la tabla fivem_panel.licenses: ~6 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.multicharacter_slots: ~0 rows (aproximadamente)
DELETE FROM `multicharacter_slots`;

-- Volcando datos para la tabla fivem_panel.owned_vehicles: ~0 rows (aproximadamente)
DELETE FROM `owned_vehicles`;

-- Volcando datos para la tabla fivem_panel.rented_vehicles: ~0 rows (aproximadamente)
DELETE FROM `rented_vehicles`;

-- Volcando datos para la tabla fivem_panel.society_moneywash: ~0 rows (aproximadamente)
DELETE FROM `society_moneywash`;

-- Volcando datos para la tabla fivem_panel.user_licenses: ~0 rows (aproximadamente)
DELETE FROM `user_licenses`;

-- Volcando datos para la tabla fivem_panel.users: ~1 rows (aproximadamente)
DELETE FROM `users`;
INSERT INTO `users` (`identifier`, `ssn`, `accounts`, `group`, `web_password`, `inventory`, `job`, `job_grade`, `loadout`, `metadata`, `position`, `firstname`, `lastname`, `dateofbirth`, `sex`, `height`, `skin`, `status`, `is_dead`, `id`, `disabled`, `last_property`, `created_at`, `last_seen`, `phone_number`, `pincode`) VALUES
	('license:admin123', '111-22-3333', NULL, 'admin', '1234', NULL, 'unemployed', 0, NULL, NULL, NULL, 'Daniel', 'Admin', NULL, NULL, NULL, NULL, NULL, 0, 3, 0, NULL, '2026-03-10 15:44:46', NULL, NULL, NULL);

-- Volcando datos para la tabla fivem_panel.vehicle_categories: ~11 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.vehicle_sold: ~0 rows (aproximadamente)
DELETE FROM `vehicle_sold`;

-- Volcando datos para la tabla fivem_panel.vehicles: ~240 rows (aproximadamente)
...
-- Volcando datos para la tabla fivem_panel.whitelist: ~0 rows (aproximadamente)
